  ...
  (function() {
    window.ogmaSDK.ready(function(sdk) {
      try {
        ...
        root.style.cssText = "padding:16px;font-family:system-ui,sans-serif;color:var(--plugin-text,#e2e4ed);background:var(--plugin-bg,#0f1117);min-height:100%";
        ...
        info.style.cssText = "font-size:12px;color:var(--plugin-text-muted,#6b7280);margin:0 0 16px 0;line-height:1.5";
        ...
        for (const col of ["Header", "Severity"]) {
          ...
          th.style.cssText = "text-align:left;padding:4px 8px;color:var(--plugin-text-muted,#9ca3af);font-weight:500;border-bottom:1px solid var(--plugin-border,#1f2230)";
        ...
        for (const c of checks) {
          ...
          tdName.style.cssText = "font-family:monospace;padding:4px 8px;border-bottom:1px solid var(--plugin-border,#1f2230);color:var(--plugin-text,#e2e4ed)";
          const tdSev = document.createElement("td");
          tdSev.textContent = c.severity;
          tdSev.style.cssText = "padding:4px 8px;border-bottom:1px solid var(--plugin-border,#1f2230);color:" + severityColor(c.severity);
